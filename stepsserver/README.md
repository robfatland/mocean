...
The idea is to bounce the player from one route to another. Each route has its own particular "answer" and gives hints 
as the player makes guesses. The best developed is the first where you must enter a prime bigger than 100. 
